...
public class ObjectSerializable {
	...
	public static void main(String[] args) {
		...
		try {
			...
			out.writeObject(new String ("Hello")); // "Hello"만 넣어도 가능
			...
			// 복원 순서는 저장순서에 맞게 복원 -> circle circle string
			Circle c1 = (Circle) in.readObject(); // obj를 알맞게 형변환
...
class Circle implements Serializable{ // 객체를 저장하고 싶음 사용
	
	// implements Serializable : 직렬화 대상임을 의미
	
	int x;
	int y;
	transient double r; // 저장의 대상에서 제외 -> default 값으로 저장
