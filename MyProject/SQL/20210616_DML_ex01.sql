...
insert into phoneInfo_univ values ('1','화학',2,(select idx from phoneInfo_basic where fr_name = '김미영'));
...
-- phoneInfo_univ insert 를 위해 phoneInfo_basic
insert into phoneInfo_com values ('1','비트캠프',(select idx from phoneInfo_basic where fr_name = '이수지'));
insert into phoneInfo_com values ('2','효성캠프',(select idx from phoneInfo_basic where fr_name = '최정길'));
insert into phoneInfo_com values ('3','롯데캠프',(select idx from phoneInfo_basic where fr_name = '정희원'));
-- phoneInfo_univ update
